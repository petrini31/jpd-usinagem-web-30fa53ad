...
const Pneumatica = () => {
  ...
  return (
    <section id="pneumatica" className="py-24 bg-gradient-to-br from-background via-secondary/30 to-background relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="animate-slide-up">
            ...
            <Button 
              ...
              className="mt-8 bg-primary text-primary-foreground hover:bg-primary-dark transition-colors"
            >
