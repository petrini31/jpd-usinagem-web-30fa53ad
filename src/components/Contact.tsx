...
const Contact = () => {
  ...
  return (
    <section id="contato" className="py-16 md:py-20 bg-gradient-to-b from-secondary/30 to-background">
                ...
                <Card key={index} className="group hover:shadow-medium transition-all duration-300 border border-border/50 hover:border-primary/30">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex items-start gap-4 md:gap-5">
                      <div className="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-gradient-primary rounded-full group-hover:scale-110 transition-transform duration-300 shadow-soft flex-shrink-0">
                        <info.icon className="w-5 h-5 md:w-7 md:h-7 text-primary-foreground" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        {info.link ? (
                          <a 
                            href={info.link} 
                            className="text-muted-foreground hover:text-primary transition-colors whitespace-pre-line text-sm sm:text-base md:text-lg break-words" 
                          ...
                          <p className="text-muted-foreground whitespace-pre-line text-sm sm:text-base md:text-lg">
                            {info.value}
                          </p>
                        )}
                      </div>
